...
public final class DrawingPanel extends FileFilter
    ...
    */
    ...
    // set the title the drawing panel window
    ...
    private void compareToURL() {
        ...
        try {
            ...
            URL url;
			try {
				url = new URI(COURSE_WEB_SITE).toURL();
...
*/
    ...
    private class DiffImage extends JPanel implements ActionListener,
        ...
        public void setImage1(String filename) {
            try {
	            ...
	            if (filename.startsWith("http")) {
	                setImage1(ImageIO.read(new URI(filename).toURL()));
	            } else {
        ...
        public void setImage2(String filename) {
            try {
	            if (filename.startsWith("http")) {
	                setImage2(ImageIO.read(new URI(filename).toURL()));
	            } else {
